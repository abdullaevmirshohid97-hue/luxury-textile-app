...
import { Building2, ShoppingBag, Factory, Package, Clock, Palette, Award, ArrowRight, FlaskConical, TestTube, Layers } from "lucide-react";
...
export default function Business() {
  ...
  const riskReduction = [
    { icon: FlaskConical, title: t.business.samplingFirst, description: t.business.samplingFirstDesc },
    { icon: TestTube, title: t.business.pilotOrders, description: t.business.pilotOrdersDesc },
    { icon: Layers, title: t.business.phasedProduction, description: t.business.phasedProductionDesc },
  ];
